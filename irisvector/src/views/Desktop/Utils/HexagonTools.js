...
HT.Hexagon = function (id, x, y) {
	...
	this.TopRightPoint = new HT.Point(this.x + HT.Hexagon.Static.WIDTH, this.y);
	this.BottomRightPoint = new HT.Point(this.x + HT.Hexagon.Static.WIDTH, this.y + HT.Hexagon.Static.HEIGHT);
	this.BottomLeftPoint = new HT.Point(this.x, this.y + HT.Hexagon.Static.HEIGHT);
